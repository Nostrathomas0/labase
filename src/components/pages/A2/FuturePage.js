...
const FuturePage = () => {
  console.log('NEW FUTURE PAGE LOADED - MainLayout version');
  ...
  useEffect(() => {
    ...
    progressManager.startSession('A1', 'future', currentPage + 1);
  ...
  const handleQuestionComplete = (answerData) => {
    console.log('Future question completed:', answerData);
    // This gets called when individual questions are answered
  };

  const handleLessonComplete = (completionData) => {
    console.log('Future lesson completed:', completionData);
  ...
  const currentPageData = {
    title: `Future - Page ${currentPage + 1}`,
    content: pages[currentPage]?.questions || []
  };

  console.log('About to render future, currentPageData:', currentPageData);
    ...
    <div>
      ...
      <div className="progress-display" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h3>Future - Page {currentPage + 1} Progress</h3>
            <p>
