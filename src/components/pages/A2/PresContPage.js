...
// Remember to change the import path for different topic pages
import PresContData from '../../../data/grammar/A2/1PresentContinuous.json';
import GrammarTopic from '../../GrammarTopic';
import PageTurner from '../../common/PageTurner'

const PresContPage = () => {
  const [currentPage, setCurrentPage] = useState(0); // Tracks the current page within the topic
  const { topic, pages } = PresContData; // Destructuring the data; 'topic' will be 'Present Continuous' for this page
