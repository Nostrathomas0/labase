...
const GoingToPage = () => {
  console.log('NEW GOING TO PAGE LOADED - MainLayout version');
  ...
  useEffect(() => {
    ...
    progressManager.startSession('A1', 'going to', currentPage + 1);
  ...
  const handleQuestionComplete = (answerData) => {
    console.log('Going To question completed:', answerData);
    // This gets called when individual questions are answered
  };

  const handleLessonComplete = (completionData) => {
    console.log('Going To lesson completed:', completionData);
  ...
  const currentPageData = {
    title: `Going To - Page ${currentPage + 1}`,
    content: pages[currentPage]?.questions || []
  };

  console.log('About to render going to, currentPageData:', currentPageData);
    ...
    <div>
      ...
      <div className="progress-display" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h3>Going To - Page {currentPage + 1} Progress</h3>
            <p>
