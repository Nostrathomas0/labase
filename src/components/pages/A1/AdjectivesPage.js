//AdjectivesPage.js - Updated to use MainLayout and ContentParser
import React, { useState, useEffect, useCallback } from 'react';
import MainLayout from '../../layout/MainLayout';
import AdjectivesData from '../../../data/grammar/A1/2Adjectives.json';
import PageTurner from '../../common/PageTurner';
import { ProgressManager } from '../../../utils/ProgressManager';

const AdjectivesPage = () => {
  console.log('NEW ADJECTIVES PAGE LOADED - MainLayout version');
  ...
  useEffect(() => {
    ...
    progressManager.startSession('A1', 'adjectives', currentPage + 1);
  ...
  const handleQuestionComplete = (answerData) => {
    console.log('Adjectives question completed:', answerData);
    // This gets called when individual questions are answered
  };

  const handleLessonComplete = (completionData) => {
    console.log('Adjectives lesson completed:', completionData);
  ...
  const currentPageData = {
    title: `Adjectives - Page ${currentPage + 1}`,
    content: pages[currentPage]?.questions || []
  };

  console.log('About to render adjectives, currentPageData:', currentPageData);
    ...
    <div>
      ...
      <div className="progress-display" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h3>Adjectives - Page {currentPage + 1} Progress</h3>
            <p>
