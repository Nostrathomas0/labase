...
const TherePage = () => {
  console.log('NEW THERE PAGE LOADED - MainLayout version');
  ...
  useEffect(() => {
    ...
    progressManager.startSession('A1', 'there', currentPage + 1);
  ...
  const handleQuestionComplete = (answerData) => {
    console.log('There question completed:', answerData);
    // This gets called when individual questions are answered
  };

  const handleLessonComplete = (completionData) => {
    console.log('There lesson completed:', completionData);
  ...
  const currentPageData = {
    title: `There - Page ${currentPage + 1}`,
    content: pages[currentPage]?.questions || []
  };

  console.log('About to render there, currentPageData:', currentPageData);
    ...
    <div>
      ...
      <div className="progress-display" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h3>There - Page {currentPage + 1} Progress</h3>
            <p>
