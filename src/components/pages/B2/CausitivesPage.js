...
const CausitivesPage = () => {
  console.log('NEW CAUSITIVES PAGE LOADED - MainLayout version');
  ...
  useEffect(() => {
    ...
    progressManager.startSession('A1', 'causitives', currentPage + 1);
  ...
  const handleQuestionComplete = (answerData) => {
    console.log('Causitives question completed:', answerData);
    // This gets called when individual questions are answered
  };

  const handleLessonComplete = (completionData) => {
    console.log('Causitives lesson completed:', completionData);
  ...
  const currentPageData = {
    title: `Causitives - Page ${currentPage + 1}`,
    content: pages[currentPage]?.questions || []
  };

  console.log('About to render causitives, currentPageData:', currentPageData);
    ...
    <div>
      ...
      <div className="progress-display" style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h3>Causitives - Page {currentPage + 1} Progress</h3>
            <p>
